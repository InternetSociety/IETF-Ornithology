...
* <IETFschedule meets=false>SETTLE likely does not meet at IETF126</IETFschedule>
...
As encryption is now standard on the public Internet, modern browsers increasingly require a secure context for web services. On local and private networks, this can make devices harder to use. It can also reduce overall security.